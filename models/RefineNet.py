...
from models.LAMNet import PositionLinearAttention, ChannelLinearAttention

from models.resnet import get_resnet101

from models.blocks import (RefineNetBlock, ResidualConvUnit,
                    RefineNetBlockImprovedPooling, ChainedResidualPool)


class BaseRefineNet4Cascade(nn.Module):
    def __init__(self, input_channel, input_size, refinenet_block, num_classes=1, features=256,
                 resnet_factory=models.resnet101, bn_momentum=0.01, pretrained=True,
                 freeze_resnet=False, attention=False):
        ...
        self.Resnet101 = get_resnet101(input_channel, bn_momentum=bn_momentum)
        ...
        self.pla = PositionLinearAttention(input_size // 4)
...
def get_refinenet(input_size, num_classes, features=256, bn_momentum=0.01, pretrained=True):
    resnet101 = get_resnet101(input_size, bn_momentum=bn_momentum)  # new ResNet proposed in PSPNet

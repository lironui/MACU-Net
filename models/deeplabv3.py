...
import models.resnet as resnet101
...
class DeepLabV3(nn.Module):
    def __init__(self, band, class_num, bn_momentum=0.01):
        ...
        self.name = 'deeplabv3'
        self.Resnet101 = resnet101.get_resnet101(band, dilation=[1, 1, 1, 2], bn_momentum=bn_momentum, is_fpn=False)
...
class DeepLabV3LAM(nn.Module):
    def __init__(self, band, class_num, bn_momentum=0.01):
        super(DeepLabV3LAM, self).__init__()
        self.name = 'DeepLabV3LAM'
        self.Resnet101 = resnet101.get_resnet101(band, dilation=[1, 1, 1, 2], bn_momentum=bn_momentum, is_fpn=False)
        self.ASPP = ASPP(2048, 256, [6, 12, 18], norm_act=nn.BatchNorm2d)
